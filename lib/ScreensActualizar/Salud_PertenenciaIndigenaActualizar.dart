...
class Salud_PertenenciaIndigenaActualizar extends StatefulWidget {
  ...
  @override
  State<Salud_PertenenciaIndigenaActualizar> createState() =>
      _Salud_PertenenciaIndigenaActualizarState();
}

class _Salud_PertenenciaIndigenaActualizarState
    extends State<Salud_PertenenciaIndigenaActualizar> {
  ...
  getAllSaludPertenencia1() async {
    ...
    if (_SaludPertenencia1.map((e) => e.incompleto.toString()).first ==
        "incompleto") {
      _incompleto1 = Check.incompleto;
    } else {
      _incompleto1 = Check.completo;
    }
  ...
  getAllSaludPertenencia2() async {
    ...
    if (_SaludPertenencia2.map((e) => e.incompleto.toString()).first ==
        "incompleto") {
      _incompleto2 = Check.incompleto;
    } else {
      _incompleto2 = Check.completo;
    }
  ...
  getAllSaludPertenencia3() async {
    ...
    if (_SaludPertenencia3.map((e) => e.incompleto.toString()).first ==
        "incompleto") {
      _incompleto3 = Check.incompleto;
    } else {
      _incompleto3 = Check.completo;
    }
  ...
  getAllSaludPertenencia4() async {
    ...
    if(_SaludPertenencia4.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto4 = Check.incompleto;
    }else{
      _incompleto4 = Check.completo;
    }
  ...
  getAllSaludPertenencia5() async {
    ...
    if(_SaludPertenencia5.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto5 = Check.incompleto;
    }else{
      _incompleto5 = Check.completo;
    }
  ...
  getAllSaludPertenencia6() async {
    ...
    if(_SaludPertenencia6.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto6 = Check.incompleto;
    }else{
      _incompleto6 = Check.completo;
    }
  ...
  getAllSaludPertenencia7() async {
    ...
    if(_SaludPertenencia7.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto7 = Check.incompleto;
    }else{
      _incompleto7 = Check.completo;
    }
  ...
  getAllSaludPertenencia8() async {
    ...
    if(_SaludPertenencia8.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto8 = Check.incompleto;
    }else{
      _incompleto8 = Check.completo;
    }
  ...
  getAllSaludPertenencia9() async {
    ...
    if(_SaludPertenencia9.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto9 = Check.incompleto;
    }else{
      _incompleto9 = Check.completo;
    }
  ...
  getAllSaludPertenencia10() async {
    ...
    if(_SaludPertenencia10.map((e) => e.incompleto.toString()).first == "incompleto"){
      _incompleto10 = Check.incompleto;
    }else{
      _incompleto10 = Check.completo;
    }
