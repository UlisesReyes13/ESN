...
import 'package:esn/Model/ApoyoFrecuencia.dart';
import 'package:esn/Model/ApoyosGobMx.dart';
...
class ApoyosEnEspecieActualizar extends StatefulWidget {
  String folio;

  ApoyosEnEspecieActualizar(this.folio);

  @override
  State<ApoyosEnEspecieActualizar> createState() => _ApoyosEnEspecieState();
}
