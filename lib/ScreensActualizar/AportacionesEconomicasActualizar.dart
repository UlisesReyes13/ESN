...
class AportacionesEconomicasActualizar extends StatefulWidget {

  String folio;

  AportacionesEconomicasActualizar(this.folio);

  @override
  State<AportacionesEconomicasActualizar> createState() => _AportacionesEconomicasState();
}


class _AportacionesEconomicasState extends State<AportacionesEconomicasActualizar> {
