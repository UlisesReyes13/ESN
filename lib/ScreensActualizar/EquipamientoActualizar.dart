...
class EquipamientoActualizar extends StatefulWidget {
  String folio;
  EquipamientoActualizar(this.folio);

  @override
  State<EquipamientoActualizar> createState() => _EquipamientoActualizarState();
}

class _EquipamientoActualizarState extends State<EquipamientoActualizar> {
