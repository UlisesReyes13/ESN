            ...
            if (int.parse(_fechaNacimiento1.text.substring(3, 5)) >= 1 &&
              ...
              if (int.parse(_fechaNacimiento1.text.substring(6, 10)) <= 2022) {
                ...
                EstructuraFamilarModel DModel = EstructuraFamilarModel(
                  ...
                  fechaNacimiento: _fechaNacimiento1.text.toString(),
                  claveEntidad:
                      _entidadNacimiento1.text.toString().substring(0, 1),
                  entidadNacimiento: entidadNacimiento.trimLeft(),
                  claveEstadoCivil:
                      _estadoCivil1.text.toString().substring(0, 1),
                  ordenEstadoCivil:
                      _estadoCivil1.text.toString().substring(0, 1),
                  estadoCivil: estado.trimLeft(),
                  claveParentesco: _parentesco1.text.toString().substring(0, 1),
                      ...
                      if (int.parse(_fechaNacimiento2.text.substring(3, 5)) >=
                        ...
                        if (int.parse(
                          ...
                          EstructuraFamilarModel DModel =
                            ...
                            estadoCivil: estado.trimLeft(),
                            claveParentesco:
                                _parentesco1.text.toString().substring(0, 1),
                            ordenParentesco:
                                _parentesco1.text.toString().substring(0, 1),
                            parentesco: parentesco.trimLeft(),
                          );
                          ...
                          EstructuraFamilarModel DModel2 =
                            ...
                            entidadNacimiento: entidadNacimiento2.trimLeft(),
                            claveEstadoCivil:
                                _estadoCivil2.text.toString().substring(0, 1),
                            ordenEstadoCivil:
                                _estadoCivil2.text.toString().substring(0, 1),
                            estadoCivil: estado2.trimLeft(),
                            claveParentesco:
                                _parentesco2.text.toString().substring(0, 1),
                            ordenParentesco:
                                _parentesco2.text.toString().substring(0, 1),
                            parentesco: parentesco2.trimLeft(),
                          );
                          await dbHelper
                              .saveEstructuraFamiliar(DModel2)
                              .then((estructuraFamilar) {
                            alertDialog(context, "Se registro correctamente");
                            Navigator.of(context).push(MaterialPageRoute<Null>(
                                builder: (BuildContext context) {
                              return new Escolaridad_SeguridadSocialTabla(
                                  widget.folio);
                            }));
                          }).catchError((error) {
                            print(error);
                          ...
                          alertDialog(
                              context, "El año en la fecha no corresponde");
                        }
                      } else {
                        alertDialog(context,
                              ...
                              if (int.parse(_fechaNacimiento3.text
                                ...
                                if (int.parse(_fechaNacimiento3.text
                                  ...
                                  if (int.parse(_fechaNacimiento3.text
                                    ...
                                    var EstadoCivil = _estadoCivil1.text
                                        .toString(); // 'artlang'
                                    final estado =
                                        EstadoCivil.replaceAll("1", "")
                                            .replaceAll("2", "")
                                            .replaceAll("3", "")
                                            .replaceAll("4", "")
                                            .replaceAll("5", "")
                                            ...
                                            .replaceAll("9", "")
                                            .replaceAll("0", "");
                                    var Parentesco = _parentesco1.text
                                        .toString(); // 'artlang'
                                    final parentesco =
                                        Parentesco.replaceAll("1", "")
                                            .replaceAll("2", "")
                                            .replaceAll("3", "")
                                            .replaceAll("4", "")
                                            .replaceAll("5", "")
                                    ...
                                    var EntidadN = _entidadNacimiento1.text
                                        .toString(); // 'artlang'
                                    final entidadNacimiento =
                                        EntidadN.replaceAll("1", "")
                                            .replaceAll("2", "");
                                    ...
                                    EstructuraFamilarModel DModel =
                                      ...
                                      nombre: _nombre1.text.toString(),
                                      primerApellido:
                                          _primerApellido1.text.toString(),
                                      segundoApellido:
                                          _segundoApellido1.text.toString(),
                                      claveSexo: sexo1.substring(0, 1),
                                      ordenSexo: sexo1.substring(0, 1),
                                      sexo: _sexo1.name.toString(),
                                      fechaNacimiento:
                                          _fechaNacimiento1.text.toString(),
                                      claveEntidad: _entidadNacimiento1.text
                                          .toString()
                                          .substring(0, 1),
                                      entidadNacimiento:
                                          entidadNacimiento.trimLeft(),
                                      claveEstadoCivil: _estadoCivil1.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenEstadoCivil: _estadoCivil1.text
                                          .toString()
                                          .substring(0, 1),
                                      estadoCivil: estado.trimLeft(),
                                      claveParentesco: _parentesco1.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenParentesco: _parentesco1.text
                                          .toString()
                                          .substring(0, 1),
                                      parentesco: parentesco.trimLeft(),
                                    );
                                    ...
                                    var EstadoCivil2 = _estadoCivil2.text
                                        .toString(); // 'artlang'
                                    final estado2 =
                                        EstadoCivil2.replaceAll("1", "")
                                            .replaceAll("2", "")
                                            .replaceAll("3", "")
                                            .replaceAll("4", "")
                                            .replaceAll("5", "")
                                            ...
                                            .replaceAll("9", "")
                                            .replaceAll("0", "");
                                    var Parentesco2 = _parentesco2.text
                                        .toString(); // 'artlang'
                                    final parentesco2 =
                                        Parentesco2.replaceAll("1", "")
                                            .replaceAll("2", "")
                                            .replaceAll("3", "")
                                            .replaceAll("4", "")
                                            .replaceAll("5", "")
                                    ...
                                    var EntidadN2 = _entidadNacimiento2.text
                                        .toString(); // 'artlang'
                                    final entidadNacimiento2 =
                                        EntidadN2.replaceAll("1", "")
                                            .replaceAll("2", "");
                                    ...
                                    EstructuraFamilarModel DModel2 =
                                      ...
                                      nombre: _nombre2.text.toString(),
                                      primerApellido:
                                          _primerApellido2.text.toString(),
                                      segundoApellido:
                                          _segundoApellido2.text.toString(),
                                      claveSexo: sexo2.substring(0, 1),
                                      ordenSexo: sexo2.substring(0, 1),
                                      sexo: _sexo2.name.toString(),
                                      fechaNacimiento:
                                          _fechaNacimiento2.text.toString(),
                                      claveEntidad: _entidadNacimiento2.text
                                          .toString()
                                          .substring(0, 1),
                                      entidadNacimiento:
                                          entidadNacimiento2.trimLeft(),
                                      claveEstadoCivil: _estadoCivil2.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenEstadoCivil: _estadoCivil2.text
                                          .toString()
                                          .substring(0, 1),
                                      estadoCivil: estado2.trimLeft(),
                                      claveParentesco: _parentesco2.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenParentesco: _parentesco2.text
                                          .toString()
                                          .substring(0, 1),
                                      parentesco: parentesco2.trimLeft(),
                                    );
                                    ...
                                    EstructuraFamilarModel DModel3 =
                                      ...
                                      claveEntidad: _entidadNacimiento3.text
                                          ...
                                          .substring(0, 1),
                                      entidadNacimiento:
                                          entidadNacimiento3.trimLeft(),
                                      claveEstadoCivil: _estadoCivil3.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenEstadoCivil: _estadoCivil3.text
                                          .toString()
                                          .substring(0, 1),
                                      estadoCivil: estado3.trimLeft(),
                                      claveParentesco: _parentesco3.text
                                          .toString()
                                          .substring(0, 1),
                                      ordenParentesco: _parentesco3.text
                                          .toString()
                                          .substring(0, 1),
                                      parentesco: parentesco3.trimLeft(),
                                    );
                                    await dbHelper
                                        .saveEstructuraFamiliar(DModel3)
                                        .then((estructuraFamilar) {
                                      alertDialog(
                                          context, "Se registro correctamente");
                                      Navigator.of(context).push(
                                    ...
                                    alertDialog(context,
                                        "El año en la fecha no corresponde");
                                  }
                                } else {
                                  alertDialog(context,
                                      "El mes seleccionado en la fecha no es correcto");
                                        ...
                                        if (int.parse(_fechaNacimiento4.text
                                          ...
                                          if (int.parse(_fechaNacimiento4.text
                                            ...
                                            if (int.parse(_fechaNacimiento4.text
                                              ...
                                              var EstadoCivil = _estadoCivil1
                                                  .text
                                                  .toString(); // 'artlang'
                                              final estado =
                                                  EstadoCivil.replaceAll(
                                                          "1", "")
                                                      .replaceAll("2", "")
                                                      .replaceAll("3", "")
                                                      .replaceAll("4", "")
                                              ...
                                              var EntidadN = _entidadNacimiento1
                                                  .text
                                                  .toString(); // 'artlang'
                                              final entidadNacimiento =
                                                  EntidadN.replaceAll("1", "")
                                              ...
                                              EstructuraFamilarModel DModel =
                                                ...
                                                folio: int.parse(widget.folio),
                                                nombre:
                                                    _nombre1.text.toString(),
                                                primerApellido: _primerApellido1
                                                    .text
                                                    .toString(),
                                                segundoApellido:
                                                    _segundoApellido1.text
                                                ...
                                                entidadNacimiento:
                                                    entidadNacimiento
                                                        .trimLeft(),
                                                claveEstadoCivil: _estadoCivil1
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenEstadoCivil: _estadoCivil1
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                estadoCivil: estado.trimLeft(),
                                                claveParentesco: _parentesco1
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenParentesco: _parentesco1
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                parentesco:
                                              ...
                                              var EstadoCivil2 = _estadoCivil2
                                                  .text
                                                  .toString(); // 'artlang'
                                              final estado2 =
                                                  EstadoCivil2.replaceAll(
                                                          "1", "")
                                                      .replaceAll("2", "")
                                                      .replaceAll("3", "")
                                                      .replaceAll("4", "")
                                                      ...
                                                      .replaceAll("9", "")
                                                      .replaceAll("0", "");
                                              var Parentesco2 = _parentesco2
                                                  .text
                                                  .toString(); // 'artlang'
                                              final parentesco2 =
                                                  Parentesco2.replaceAll(
                                                          "1", "")
                                                      .replaceAll("2", "")
                                                      .replaceAll("3", "")
                                                      .replaceAll("4", "")
                                              ...
                                              EstructuraFamilarModel DModel2 =
                                                ...
                                                folio: int.parse(widget.folio),
                                                nombre:
                                                    _nombre2.text.toString(),
                                                primerApellido: _primerApellido2
                                                    .text
                                                    .toString(),
                                                segundoApellido:
                                                    _segundoApellido2.text
                                                ...
                                                entidadNacimiento:
                                                    entidadNacimiento2
                                                        .trimLeft(),
                                                claveEstadoCivil: _estadoCivil2
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenEstadoCivil: _estadoCivil2
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                estadoCivil: estado2.trimLeft(),
                                                claveParentesco: _parentesco2
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenParentesco: _parentesco2
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                parentesco:
                                                    parentesco2.trimLeft(),
                                              );
                                              await dbHelper
                                                  .saveEstructuraFamiliar(
                                                      DModel2)
                                              ...
                                              var EstadoCivil3 = _estadoCivil3
                                                  .text
                                                  .toString(); // 'artlang'
                                              final estado3 =
                                                  EstadoCivil3.replaceAll(
                                                          "1", "")
                                                      .replaceAll("2", "")
                                                      .replaceAll("3", "")
                                                      .replaceAll("4", "")
                                                      ...
                                                      .replaceAll("9", "")
                                                      .replaceAll("0", "");
                                              var Parentesco3 = _parentesco3
                                                  .text
                                                  .toString(); // 'artlang'
                                              final parentesco3 =
                                                  Parentesco3.replaceAll(
                                                          "1", "")
                                                      .replaceAll("2", "")
                                                      .replaceAll("3", "")
                                                      .replaceAll("4", "")
                                              ...
                                              EstructuraFamilarModel DModel3 =
                                                ...
                                                folio: int.parse(widget.folio),
                                                nombre:
                                                    _nombre3.text.toString(),
                                                primerApellido: _primerApellido3
                                                    .text
                                                    .toString(),
                                                segundoApellido:
                                                    _segundoApellido3.text
                                                ...
                                                entidadNacimiento:
                                                    entidadNacimiento3
                                                        .trimLeft(),
                                                claveEstadoCivil: _estadoCivil3
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenEstadoCivil: _estadoCivil3
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                estadoCivil: estado3.trimLeft(),
                                                claveParentesco: _parentesco3
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenParentesco: _parentesco3
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                parentesco:
                                                    parentesco3.trimLeft(),
                                              );
                                              await dbHelper
                                                  .saveEstructuraFamiliar(
                                                      DModel3)
                                              ...
                                              EstructuraFamilarModel DModel4 =
                                                ...
                                                entidadNacimiento:
                                                    entidadNacimiento4
                                                        .trimLeft(),
                                                claveEstadoCivil: _estadoCivil4
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenEstadoCivil: _estadoCivil4
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                estadoCivil: estado4.trimLeft(),
                                                claveParentesco: _parentesco4
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                ordenParentesco: _parentesco4
                                                    .text
                                                    .toString()
                                                    .substring(0, 1),
                                                parentesco:
                                                                ...
                                                                if (int.parse(_fechaNacimiento6
                                                                  ...
                                                                  var EntidadN =
                                                                      _entidadNacimiento1
                                                                          .text
                                                                          .toString(); // 'artlang'
                                                                  final entidadNacimiento = EntidadN
                                                                          .replaceAll(
                                                                              "1",
                                                                              "")
                                                                      .replaceAll(
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento1
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento1
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                  ...
                                                                  var EntidadN2 =
                                                                      _entidadNacimiento2
                                                                          .text
                                                                          .toString(); // 'artlang'
                                                                  final entidadNacimiento2 = EntidadN2
                                                                          .replaceAll(
                                                                              "1",
                                                                              "")
                                                                      .replaceAll(
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento2
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento2
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                  ...
                                                                  var EntidadN3 =
                                                                      _entidadNacimiento3
                                                                          .text
                                                                          .toString(); // 'artlang'
                                                                  final entidadNacimiento3 = EntidadN3
                                                                          .replaceAll(
                                                                              "1",
                                                                              "")
                                                                      .replaceAll(
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento3
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento3
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                  ...
                                                                  var EntidadN4 =
                                                                      _entidadNacimiento4
                                                                          .text
                                                                          .toString(); // 'artlang'
                                                                  final entidadNacimiento4 = EntidadN4
                                                                          .replaceAll(
                                                                              "1",
                                                                              "")
                                                                      .replaceAll(
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento4
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento4
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                  ...
                                                                  var EntidadN5 =
                                                                      _entidadNacimiento5
                                                                          .text
                                                                          .toString(); // 'artlang'
                                                                  final entidadNacimiento5 = EntidadN5
                                                                          .replaceAll(
                                                                              "1",
                                                                              "")
                                                                      .replaceAll(
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento5
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento5
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                    ...
                                                                    entidadNacimiento:
                                                                        entidadNacimiento5
                                                                            .trimLeft(),
                                                                    claveEstadoCivil: _estadoCivil5
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                            1),
                                                                    ordenEstadoCivil: _estadoCivil5
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                    ...
                                                                    estadoCivil:
                                                                        estado5
                                                                            .trimLeft(),
                                                                    claveParentesco: _parentesco5
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                            1),
                                                                    ordenParentesco: _parentesco5
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                  ...
                                                                  EstructuraFamilarModel
                                                                    ...
                                                                    fechaNacimiento:
                                                                        _fechaNacimiento6
                                                                            .text
                                                                            .toString(),
                                                                    claveEntidad: _entidadNacimiento6
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                    ...
                                                                    entidadNacimiento:
                                                                        entidadNacimiento6
                                                                            .trimLeft(),
                                                                    claveEstadoCivil: _estadoCivil6
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                            1),
                                                                    ordenEstadoCivil: _estadoCivil6
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                    ...
                                                                    estadoCivil:
                                                                        estado6
                                                                            .trimLeft(),
                                                                    claveParentesco: _parentesco6
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                            1),
                                                                    ordenParentesco: _parentesco6
                                                                        .text
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                                        ...
                                                                        if (int.parse(_fechaNacimiento7.text.substring(3, 5)) >=
                                                                          ...
                                                                          if (int.parse(_fechaNacimiento7.text.substring(6, 10)) <=
                                                                            ...
                                                                            var EstadoCivil =
                                                                                _estadoCivil1.text.toString(); // 'artlang'
                                                                            final estado =
                                                                                EstadoCivil.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco =
                                                                                _parentesco1.text.toString(); // 'artlang'
                                                                            final parentesco =
                                                                                Parentesco.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel).then((estructuraFamilar) {}).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            });
                                                                            ...
                                                                            var EstadoCivil2 =
                                                                                _estadoCivil2.text.toString(); // 'artlang'
                                                                            final estado2 =
                                                                                EstadoCivil2.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco2 =
                                                                                _parentesco2.text.toString(); // 'artlang'
                                                                            final parentesco2 =
                                                                                Parentesco2.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel2).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                            }).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            ...
                                                                            var EstadoCivil3 =
                                                                                _estadoCivil3.text.toString(); // 'artlang'
                                                                            final estado3 =
                                                                                EstadoCivil3.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco3 =
                                                                                _parentesco3.text.toString(); // 'artlang'
                                                                            final parentesco3 =
                                                                                Parentesco3.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                            var EntidadN3 =
                                                                                _entidadNacimiento3.text.toString(); // 'artlang'
                                                                            final entidadNacimiento3 =
                                                                                EntidadN3.replaceAll("1", "").replaceAll("2", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel3).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                            }).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            ...
                                                                            var EstadoCivil4 =
                                                                                _estadoCivil4.text.toString(); // 'artlang'
                                                                            final estado4 =
                                                                                EstadoCivil4.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco4 =
                                                                                _parentesco4.text.toString(); // 'artlang'
                                                                            final parentesco4 =
                                                                                Parentesco4.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                            var EntidadN4 =
                                                                                _entidadNacimiento4.text.toString(); // 'artlang'
                                                                            final entidadNacimiento4 =
                                                                                EntidadN4.replaceAll("1", "").replaceAll("2", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel4).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                            }).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            ...
                                                                            var EstadoCivil5 =
                                                                                _estadoCivil5.text.toString(); // 'artlang'
                                                                            final estado5 =
                                                                                EstadoCivil5.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco5 =
                                                                                _parentesco5.text.toString(); // 'artlang'
                                                                            final parentesco5 =
                                                                                Parentesco5.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                            var EntidadN5 =
                                                                                _entidadNacimiento5.text.toString(); // 'artlang'
                                                                            final entidadNacimiento5 =
                                                                                EntidadN5.replaceAll("1", "").replaceAll("2", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel5).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                            }).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            ...
                                                                            var EstadoCivil6 =
                                                                                _estadoCivil6.text.toString(); // 'artlang'
                                                                            final estado6 =
                                                                                EstadoCivil6.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                            var Parentesco6 =
                                                                                _parentesco6.text.toString(); // 'artlang'
                                                                            final parentesco6 =
                                                                                Parentesco6.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                            var EntidadN6 =
                                                                                _entidadNacimiento6.text.toString(); // 'artlang'
                                                                            final entidadNacimiento6 =
                                                                                EntidadN6.replaceAll("1", "").replaceAll("2", "");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel6).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                            }).catchError((error) {
                                                                              print(error);
                                                                              alertDialog(context, "Error: No se guardaron los datos");
                                                                            ...
                                                                            await dbHelper.saveEstructuraFamiliar(DModel7).then((estructuraFamilar) {
                                                                              alertDialog(context, "Se registro correctamente");
                                                                                ...
                                                                                if (int.parse(_fechaNacimiento8.text.substring(0, 2)) >= 1 && int.parse(_fechaNacimiento8.text.substring(0, 2)) <= 31) {
                                                                                  if (int.parse(_fechaNacimiento8.text.substring(3, 5)) >= 1 && int.parse(_fechaNacimiento8.text.substring(3, 5)) <= 12) {
                                                                                    if (int.parse(_fechaNacimiento8.text.substring(6, 10)) <= 2022) {
                                                                                      ...
                                                                                      var EstadoCivil = _estadoCivil1.text.toString(); // 'artlang'
                                                                                      final estado = EstadoCivil.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco = _parentesco1.text.toString(); // 'artlang'
                                                                                      final parentesco = Parentesco.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN = _entidadNacimiento1.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento = EntidadN.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil2 = _estadoCivil2.text.toString(); // 'artlang'
                                                                                      final estado2 = EstadoCivil2.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco2 = _parentesco2.text.toString(); // 'artlang'
                                                                                      final parentesco2 = Parentesco2.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN2 = _entidadNacimiento2.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento2 = EntidadN2.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil3 = _estadoCivil3.text.toString(); // 'artlang'
                                                                                      final estado3 = EstadoCivil3.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco3 = _parentesco3.text.toString(); // 'artlang'
                                                                                      final parentesco3 = Parentesco3.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN3 = _entidadNacimiento3.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento3 = EntidadN3.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil4 = _estadoCivil4.text.toString(); // 'artlang'
                                                                                      final estado4 = EstadoCivil4.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco4 = _parentesco4.text.toString(); // 'artlang'
                                                                                      final parentesco4 = Parentesco4.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN4 = _entidadNacimiento4.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento4 = EntidadN4.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil5 = _estadoCivil5.text.toString(); // 'artlang'
                                                                                      final estado5 = EstadoCivil5.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco5 = _parentesco5.text.toString(); // 'artlang'
                                                                                      final parentesco5 = Parentesco5.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN5 = _entidadNacimiento5.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento5 = EntidadN5.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil6 = _estadoCivil6.text.toString(); // 'artlang'
                                                                                      final estado6 = EstadoCivil6.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco6 = _parentesco6.text.toString(); // 'artlang'
                                                                                      final parentesco6 = Parentesco6.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN6 = _entidadNacimiento6.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento6 = EntidadN6.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      var EstadoCivil7 = _estadoCivil7.text.toString(); // 'artlang'
                                                                                      final estado7 = EstadoCivil7.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");
                                                                                      var Parentesco7 = _parentesco7.text.toString(); // 'artlang'
                                                                                      final parentesco7 = Parentesco7.replaceAll("1", "").replaceAll("2", "").replaceAll("3", "").replaceAll("4", "").replaceAll("5", "").replaceAll("6", "").replaceAll("7", "").replaceAll("8", "").replaceAll("9", "").replaceAll("0", "");

                                                                                      var EntidadN7 = _entidadNacimiento7.text.toString(); // 'artlang'
                                                                                      final entidadNacimiento7 = EntidadN7.replaceAll("1", "").replaceAll("2", "");
                                                                                      ...
                                                                                      await dbHelper.saveEstructuraFamiliar(DModel8).then((estructuraFamilar) {
                                                                                        alertDialog(context, "Se registro correctamente");
                                                                                        Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {
                                                                                          return new Escolaridad_SeguridadSocialTabla(widget.folio);
                                                                                        }));
                                                                                          ...
                                                                                          if (int.parse(_fechaNacimiento9.text.substring(0, 2)) >= 1 && int.parse(_fechaNacimiento9.text.substring(0, 2)) <= 31) {
                                                                                            if (int.parse(_fechaNacimiento9.text.substring(3, 5)) >= 1 && int.parse(_fechaNacimiento9.text.substring(3, 5)) <= 12) {
                                                                                              if (int.parse(_fechaNacimiento9.text.substring(6, 10)) <= 2022) {
                                                                                                ...
                                                                                                var EntidadN9 = _entidadNacimiento9.text.toString(); // 'artlang'
                                                                                                final entidadNacimiento9 = EntidadN9.replaceAll("1", "").replaceAll("2", "");
                                                                                                ...
                                                                                                await dbHelper.saveEstructuraFamiliar(DModel9).then((estructuraFamilar) {
                                                                                                  alertDialog(context, "Se registro correctamente");
                                                                                                  Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {
                                                                                                    return new Escolaridad_SeguridadSocialTabla(widget.folio);
                                                                                                  }));
                                                                                                    ...
                                                                                                    if (int.parse(_fechaNacimiento10.text.substring(0, 2)) >= 1 && int.parse(_fechaNacimiento10.text.substring(0, 2)) <= 31) {
                                                                                                      if (int.parse(_fechaNacimiento10.text.substring(3, 5)) >= 1 && int.parse(_fechaNacimiento10.text.substring(3, 5)) <= 12) {
                                                                                                        if (int.parse(_fechaNacimiento10.text.substring(6, 10)) <= 2022) {
                                                                                                          ...
                                                                                                          var EntidadN10 = _entidadNacimiento10.text.toString(); // 'artlang'
                                                                                                          final entidadNacimiento10 = EntidadN10.replaceAll("1", "").replaceAll("2", "");
                                                                                                          ...
                                                                                                          await dbHelper.saveEstructuraFamiliar(DModel10).then((estructuraFamilar) {
                                                                                                            alertDialog(context, "Se registro correctamente");
                                                                                                            Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {
                                                                                                              return new Escolaridad_SeguridadSocialTabla(widget.folio);
                                                                                                            }));
