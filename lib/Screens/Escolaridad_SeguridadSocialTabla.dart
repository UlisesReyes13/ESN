...
class _Escolaridad_SeguridadSocialTablaState extends State<Escolaridad_SeguridadSocialTabla> {
  ...
  List<EscolaridadSeguridadSocial> _Escolaridad1 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad2 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad3 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad4 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad5 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad6 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad7 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad8 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad9 = List<EscolaridadSeguridadSocial>();
  List<EscolaridadSeguridadSocial> _Escolaridad10 = List<EscolaridadSeguridadSocial>();
  ...
  getAllEscolaridad1() async {
    ...
    var categories = await CategoryService().readEscolaridad1(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        ...
        categoryModel.int_OrdenPrestacionesLab = category['int_OrdenPrestacionesLab'];
        categoryModel.txt_desc_prestacioneslab = category['txt_desc_prestacioneslab'];
        ...
        categoryModel.ClaveMotivoDerechohabiencia = category['ClaveMotivoDerechohabiencia'];
        categoryModel.OrdenMotivoDerechohabiencia = category['OrdenMotivoDerechohabiencia'];
        categoryModel.MotivoDerechohabiencia  = category['MotivoDerechohabiencia'];

        _Escolaridad1.add(categoryModel);
      });
    });
    _escolaridad1.text = _Escolaridad1.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad1.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad1.map((e) => e.Escolaridad).first;

    _gradoEscolar1.text = _Escolaridad1.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad1.map((e) => e.GradoEscolar).first;

    _ocupacion1.text = _Escolaridad1.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad1.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad1.map((e) => e.Ocupacion).first;

    _tipoEmpleo1.text = _Escolaridad1.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad1.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad1.map((e) => e.TipoEmpleo).first;

    _derechohabiencia1.text = _Escolaridad1.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad1.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad1.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia1.text = _Escolaridad1.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad1.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad2() async {
    ...
    var categories = await CategoryService().readEscolaridad2(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad2.text = _Escolaridad2.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad2.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad2.map((e) => e.Escolaridad).first;

    _gradoEscolar2.text = _Escolaridad2.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad2.map((e) => e.GradoEscolar).first;

    _ocupacion2.text = _Escolaridad2.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad2.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad2.map((e) => e.Ocupacion).first;

    _tipoEmpleo2.text = _Escolaridad2.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad2.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad2.map((e) => e.TipoEmpleo).first;

    _derechohabiencia2.text = _Escolaridad2.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad2.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad2.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia2.text = _Escolaridad2.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad2.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad3() async {
    ...
    var categories = await CategoryService().readEscolaridad3(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad3.text = _Escolaridad3.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad3.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad3.map((e) => e.Escolaridad).first;

    _gradoEscolar3.text = _Escolaridad3.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad3.map((e) => e.GradoEscolar).first;

    _ocupacion3.text = _Escolaridad3.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad3.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad3.map((e) => e.Ocupacion).first;

    _tipoEmpleo3.text = _Escolaridad3.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad3.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad3.map((e) => e.TipoEmpleo).first;

    _derechohabiencia3.text = _Escolaridad3.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad3.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad3.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia3.text = _Escolaridad3.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad3.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad4() async {
    ...
    var categories = await CategoryService().readEscolaridad4(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad4.text = _Escolaridad4.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad4.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad4.map((e) => e.Escolaridad).first;

    _gradoEscolar4.text = _Escolaridad4.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad4.map((e) => e.GradoEscolar).first;

    _ocupacion4.text = _Escolaridad4.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad4.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad4.map((e) => e.Ocupacion).first;

    _tipoEmpleo4.text = _Escolaridad4.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad4.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad4.map((e) => e.TipoEmpleo).first;

    _derechohabiencia4.text = _Escolaridad4.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad4.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad4.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia4.text = _Escolaridad4.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad4.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad5() async {
    ...
    var categories = await CategoryService().readEscolaridad5(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad5.text = _Escolaridad5.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad5.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad5.map((e) => e.Escolaridad).first;

    _gradoEscolar5.text = _Escolaridad5.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad5.map((e) => e.GradoEscolar).first;

    _ocupacion5.text = _Escolaridad5.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad5.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad5.map((e) => e.Ocupacion).first;

    _tipoEmpleo5.text = _Escolaridad5.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad5.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad5.map((e) => e.TipoEmpleo).first;

    _derechohabiencia5.text = _Escolaridad5.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad5.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad5.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia5.text = _Escolaridad5.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad5.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad6() async {
    ...
    var categories = await CategoryService().readEscolaridad6(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad6.text = _Escolaridad6.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad6.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad6.map((e) => e.Escolaridad).first;

    _gradoEscolar6.text = _Escolaridad6.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad6.map((e) => e.GradoEscolar).first;

    _ocupacion6.text = _Escolaridad6.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad6.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad6.map((e) => e.Ocupacion).first;

    _tipoEmpleo6.text = _Escolaridad6.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad6.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad6.map((e) => e.TipoEmpleo).first;

    _derechohabiencia6.text = _Escolaridad6.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad6.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad6.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia6.text = _Escolaridad6.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad6.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad7() async {
    ...
    var categories = await CategoryService().readEscolaridad7(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad7.text = _Escolaridad7.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad7.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad7.map((e) => e.Escolaridad).first;

    _gradoEscolar7.text = _Escolaridad7.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad7.map((e) => e.GradoEscolar).first;

    _ocupacion7.text = _Escolaridad7.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad7.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad7.map((e) => e.Ocupacion).first;

    _tipoEmpleo7.text = _Escolaridad7.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad7.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad7.map((e) => e.TipoEmpleo).first;

    _derechohabiencia7.text = _Escolaridad7.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad7.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad7.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia7.text = _Escolaridad7.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad7.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad8() async {
    ...
    var categories = await CategoryService().readEscolaridad8(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad8.text = _Escolaridad8.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad8.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad8.map((e) => e.Escolaridad).first;

    _gradoEscolar8.text = _Escolaridad8.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad8.map((e) => e.GradoEscolar).first;

    _ocupacion8.text = _Escolaridad8.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad8.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad8.map((e) => e.Ocupacion).first;

    _tipoEmpleo8.text = _Escolaridad8.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad8.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad8.map((e) => e.TipoEmpleo).first;

    _derechohabiencia8.text = _Escolaridad8.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad8.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad8.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia8.text = _Escolaridad8.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad8.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad9() async {
    ...
    var categories = await CategoryService().readEscolaridad9(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad9.text = _Escolaridad9.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad9.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad9.map((e) => e.Escolaridad).first;

    _gradoEscolar9.text = _Escolaridad9.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad9.map((e) => e.GradoEscolar).first;

    _ocupacion9.text = _Escolaridad9.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad9.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad9.map((e) => e.Ocupacion).first;

    _tipoEmpleo9.text = _Escolaridad9.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad9.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad9.map((e) => e.TipoEmpleo).first;

    _derechohabiencia9.text = _Escolaridad9.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad9.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad9.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia9.text = _Escolaridad9.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad9.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  getAllEscolaridad10() async {
    ...
    var categories = await CategoryService().readEscolaridad10(int.parse(widget.folio));
    categories.forEach((category) {
      setState(() {
        var categoryModel = EscolaridadSeguridadSocial();
        categoryModel.folio = category['folio'];
    ...
    _escolaridad10.text = _Escolaridad10.map((e) => e.ClaveEscolaridad).first + " " + _Escolaridad10.map((e) => e.ClaveEscolaridad).first
        + " " + _Escolaridad10.map((e) => e.Escolaridad).first;

    _gradoEscolar10.text = _Escolaridad10.map((e) => e.ClaveGradoEscolar).first + " " + _Escolaridad10.map((e) => e.GradoEscolar).first;

    _ocupacion10.text = _Escolaridad10.map((e) => e.ClaveOcupacion).first + " " + _Escolaridad10.map((e) => e.OrdenOcupacion).first
        + " " + _Escolaridad10.map((e) => e.Ocupacion).first;

    _tipoEmpleo10.text = _Escolaridad10.map((e) => e.ClaveTipoEmpleo).first + " " + _Escolaridad10.map((e) => e.OrdenTipoEmpleo).first
        + " " + _Escolaridad10.map((e) => e.TipoEmpleo).first;

    _derechohabiencia10.text = _Escolaridad10.map((e) => e.ClaveDerechohabiencia).first + " " + _Escolaridad10.map((e) => e.OrdenDerechohabiencia).first
        + " " + _Escolaridad10.map((e) => e.Derechohabiencia).first;

    _motivoderechohabiencia10.text = _Escolaridad10.map((e) => e.ClaveMotivoDerechohabiencia).first + " " + _Escolaridad10.map((e) => e.OrdenMotivoDerechohabiencia).first
  ...
  renglon1() async {
    ...
    final Derecho = derecho.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab = motivoDerecho.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    EscolaridadSeguridadSocial DModel = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar1.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia1.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia1.text.substring(0,2),
  ...
  upDateRenglon1() async{
    ...
    await dbHelper.upDateEscolaridad1(DModel).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon2() async{
    ...
    final Derecho2 = derecho2.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab2 = motivoDerecho2.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones2 = Prestaciones2
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel2 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar2.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia2.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia2.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab2.trimLeft(),


    );
    await dbHelper.saveEscolaridadSocial(DModel2).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon2() async{
    ...
    await dbHelper.upDateEscolaridad2(DModel2).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon3() async{
    ...
    final Derecho3 = derecho3.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab3 = motivoDerecho3.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones3 = Prestaciones3
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel3 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar3.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia3.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia3.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab3.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel3).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon3() async{
    ...
    await dbHelper.upDateEscolaridad3(DModel3).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon4() async{
    ...
    final Derecho4 = derecho4.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab4 = motivoDerecho4.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones4 = Prestaciones4
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel4 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar4.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia4.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia4.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab4.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel4).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon4() async{
    ...
    await dbHelper.upDateEscolaridad4(DModel4).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon5() async{
    ...
    final Derecho5 = derecho5.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab5 = motivoDerecho5.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones5 = Prestaciones5
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel5 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar5.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia5.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia5.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab5.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel5).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon5() async{
    ...
    await dbHelper.upDateEscolaridad5(DModel5).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon6() async{
    ...
    final Derecho6 = derecho6.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab6 = motivoDerecho6.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones6 = Prestaciones6
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel6 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar6.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia6.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia6.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab6.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel6).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
  ...
  upDateRenglon6() async{
    ...
    await dbHelper.upDateEscolaridad6(DModel6).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
      Navigator.of(context)
          .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
        return new Salud_PertenenciaIndigenaTabla(widget.folio);
  ...
  renglon7() async{
    ...
    final Derecho7 = derecho7.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab7 = motivoDerecho7.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones7 = Prestaciones7
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel7 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar7.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia7.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia7.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab7.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel7).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon7() async{
    ...
    await dbHelper.upDateEscolaridad7(DModel7).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon8() async{
    ...
    final Derecho8 = derecho8.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab8 = motivoDerecho8.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones8 = Prestaciones8
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel8 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar8.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia8.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia8.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab8.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel8).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  upDateRenglon8() async{
    ...
    await dbHelper.upDateEscolaridad8(DModel8).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
    }).catchError((error) {
      print(error);
      alertDialog(context, "Error: No se guardaron los datos");
  ...
  renglon9() async{
    ...
    final Derecho9 = derecho9.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final motivoDereHab9 = motivoDerecho9.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones9 = Prestaciones9
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel9 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar9.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia9.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia9.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab9.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel9).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
      Navigator.of(context)
          .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
        return new Salud_PertenenciaIndigenaTabla(widget.folio);
  ...
  upDateRenglon9() async{
    ...
    await dbHelper.upDateEscolaridad9(DModel9).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
      Navigator.of(context)
          .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
        return new Salud_PertenenciaIndigenaTabla(widget.folio);
  ...
  renglon10() async{
    ...
    final Derecho10 = derecho10.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    var motivoDerecho10 = _motivoderechohabiencia10.text.toString(); // 'artlang'
    final motivoDereHab10 = motivoDerecho10.replaceAll("1", "")
        .replaceAll("2", "")
        .replaceAll("3", "")
        .replaceAll("4", "")
        .replaceAll("5", "")
    ...
    final prestaciones10 = Prestaciones10
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll("1", "")
        .replaceAll("2", "")
    ...
    EscolaridadSeguridadSocial DModel10 = EscolaridadSeguridadSocial(
      ...
      //arreglar
      GradoEscolar: (int.parse(_gradoEscolar10.text.substring(0,2) )- 1).toString(),
      ...
      ClaveMotivoDerechohabiencia: _motivoderechohabiencia10.text.substring(0,2),
      OrdenMotivoDerechohabiencia: _motivoderechohabiencia10.text.substring(0,2),
      MotivoDerechohabiencia: motivoDereHab10.trimLeft(),
    );
    await dbHelper.saveEscolaridadSocial(DModel10).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
      Navigator.of(context)
          .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
        return new Salud_PertenenciaIndigenaTabla(widget.folio);
  ...
  upDateRenglon10() async{
    ...
    await dbHelper.upDateEscolaridad10(DModel10).then((escolaridadSeguridadSocial) {
      alertDialog(context, "Se registro correctamente");
      Navigator.of(context)
          .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
        return new Salud_PertenenciaIndigenaTabla(widget.folio);
