...
*/
  ...
  readOrdenCodicionesSlud(String condicion) async {
    var connection = await db;
    return await connection.rawQuery(
        "select Pk_PrestacionesLaborales from tb_PrestacionesLaborales where txt_desc_prestacioneslab like '%${condicion}%'");
  }

  readPonderacionCondicionesSalud(String condicion) async {
    var connection = await db;
    return await connection.rawQuery(
        "select Orden_PrestacionesLaborales from tb_PrestacionesLaborales where txt_desc_prestacioneslab like '%${condicion}%'");
  }
